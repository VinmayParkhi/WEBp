...
exports.importRequiresChunkNameRule = void 0;
const importRequiresChunkNameRule = {
    meta: {
        type: 'problem',
        messages: {
            'error-import-requires-chunk-name': 'Usage of "import(...)" for code splitting requires a /* webpackChunkName: \'...\' */ comment',
            'error-import-requires-single-chunk-name': 'Usage of "import(...)" for code splitting cannot specify multiple /* webpackChunkName: \'...\' */ comments'
        },
        schema: [],
        docs: {
        ...
        return {
            ImportExpression: (node) => {
                ...
                if (webpackChunkNameEntries.length === 0) {
                    context.report({ node, messageId: 'error-import-requires-chunk-name' });
                }
                else if (webpackChunkNameEntries.length !== 1) {
                    context.report({ node, messageId: 'error-import-requires-single-chunk-name' });
                }
            }
        };
    }
